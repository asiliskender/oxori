...
|-----------|----------|----------|
| Architecture decisions, phase gates, API design | Flynn | Interface design, layer boundaries, public SDK shape |
...
| Phase priorities, scope, requirements, backlog | Castor | What to build next, trade-offs, phase planning |
| MCP server design, agent integration patterns | Quorra | MCP tools/resources, agent interaction ergonomics |
| Code review, reviewer gates, phase sign-off | Flynn | Reviews all PRs, approves phase completion |
...
7. **Phase gates require Flynn's approval.** No phase merge without Flynn reviewing test coverage and docs completeness.
